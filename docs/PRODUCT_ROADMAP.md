...
Status: Phase 217C isolated review presentation foundation implemented; every
platform adapter, source-specific runtime copy, and production consumer remain
disabled.
