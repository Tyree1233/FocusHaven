...
void main() {
  ...
  test(
    'reviewed Spanish catalog is exact and generated but not production',
    () {
      const digest =
      ...
      expect(qualification['runtimeIntegrationStatus'], 'generated_inactive');
      ...
      expect(FocusHavenLocales.integrationLocales, const <Locale>[
        Locale('es'),
      ]);
  ...
  testWidgets('production app falls back to English on a Spanish device', (
    tester,
  ) async {
